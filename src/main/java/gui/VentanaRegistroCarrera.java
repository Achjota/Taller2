...
public class VentanaRegistroCarrera extends Ventana{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == this.botonRegistrar){
			if(registrarCarrera()){
				universidad.añadirCarrera(this.campoNombreCarrera.getText(),(CodigoCarrera) this.listaCarreras.getSelectedItem(),Integer.parseInt(this.campoCantidadSemestres.getText()));
				JOptionPane.showMessageDialog(this,"Carrera Registrada Correctamente","Mensaje de confirmación",JOptionPane.INFORMATION_MESSAGE);
