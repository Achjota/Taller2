...
public class GestorDatos {
    public static Universidad leerArchivoEstudiantes(Universidad automotora, String direccionArchivo) {
        String textoArchivo = "";
    ...
    public static Universidad leerArchivoCarreras(Universidad universidad, String direccionArchivo) {
        String textoArchivo = "";
        try {
            File archivo = new File(direccionArchivo);
            FileReader fr = new FileReader(archivo);
